...
Original Repo could be: `https://github.com/ARambazamba/M365DevFundamentals` where `ARambazamba` is the `original-owner-github-username` and `M365DevFundamentals` is the `reponame`
...
```
git remote add upstream https://github.com/ARambazamba/M365DevFundamentals.git
```
...
> Note: If you prefer graphical support you can use [Git Extensions for Windows](https://sourceforge.net/projects/gitextensions/)
